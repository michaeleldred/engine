...
public class GLES20 {
    ...
    @Bridge
    private static native void glGetProgramInfoLog(int program, int maxLength, IntPtr length, BytePtr infoLog);

    public static String glGetProgramInfoLog(int program) {
        BytePtr infoLog = INFO_LOG.get(); 
        glGetShaderInfoLog(program, MAX_INFO_LOG_LENGTH, null, infoLog);
        return infoLog.toStringAsciiZ();
    }
